...
public abstract class Seres {
	...
	public void addCapacidad(Capacidades capacidad) {		// TODO REVISAR
		this.tiene_capacidad.add(capacidad);				// Aquí permitimos añadir capacidades repetidas (pq es una List)
	}
	
	public void removeCapacidad(Capacidades capacidad) {	// TODO REVISAR
		if ( this.tiene_capacidad.remove(capacidad) ) { 	// El "remove" ya comprueba si está o no el objeto.
			// Capacidad quitada
		}
		else {
